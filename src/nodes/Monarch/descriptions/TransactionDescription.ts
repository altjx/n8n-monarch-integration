	...
	// Update Fields collection
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'The ID of the goal to associate with this transaction. Use an empty string to clear.',
			},
			{
			...
			},
			{
				...
				default: '',
				description:
					'The merchant name for this transaction. Empty strings are ignored by the API.',
			},
			{
